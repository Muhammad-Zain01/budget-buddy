...
const GoogleButton = ({ label }: { label: string }) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      className="w-full py-2 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-300 text-gray-800 dark:text-gray-200"
      disabled={loading}
    >
      {loading ? (
